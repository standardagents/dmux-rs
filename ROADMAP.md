...
- Actions (18): view/focus ✅, close ✅, rename ✅, hide/show ✅, duplicate ✅ (same agent + prompt, fresh worktree), merge ✅, PR ✅, copyPath ✅, openInEditor ✅, toggleAutopilot ✂ (removed in #31 — agents bring their own autonomous modes; legacy `autopilot` config fields pass through untouched), test/dev runners ✅ (`run_test`/`run_dev` hooks in a terminal pane via pane menu)
